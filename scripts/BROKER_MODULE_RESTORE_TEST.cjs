...
must('src/v3/storage.ts',['normalizeBrokerProfiles','defaultBrokerProfileId','brokerProfiles:normalizeBrokerProfiles']);
...
must('App.tsx',['configureBrokerProfiles','brokerProfiles:state.brokerProfiles','defaultBrokerProfileId={state.defaultBrokerProfileId}','onBrokerProfilesChange','brokerProfileId:x.brokerProfileId']);
